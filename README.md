...
![Last test](https://github.com/andrelohmann/ansible-role-maxmind/actions/workflows/test.yml/badge.svg)

## Content

Use this role to install geoip and the maxmind database.

A maxmind account is necessary. To create an account with maxmind, follow these links:
...
Set the account_id, license_key and editions ids
    ...
    maxmind_geoipupdate_run: true # run geoipupdate during installation process
    maxmind_geoipupdate_cron: true # create a cron job to regularily run geoipupdate
